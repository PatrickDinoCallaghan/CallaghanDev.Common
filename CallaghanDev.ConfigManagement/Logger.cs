...
namespace CallaghanDev.ConfigManagement
{
    public class Logger : ILog
    {
        ...
        private Logger()
        {
            ...
            string? AppConfig = appsettings.Dir + appsettings.LoggerFile;
        ...
        private Logger(string to, string from, string frompassword, string smtphost, string authendicationvalue, bool enablessl)
        {
            _EmailLoggerActive = true;

            string? AppConfig = appsettings.configuration["OtherSettings:LoggerFilePath"];
        ...
        private void GenerateEmailLogger(string to, string from, string frompassword, string smtphost, string authendicationvalue, bool enablessl)
        {
	...
	<log4net>
		...
		<logger name=""EmailLogger"">
            ...
            string? filePath = Path.Combine(appsettings.Dir + appsettings.LoggerFile, "Log4net.config");
        ...
        private void GenerateFileLogger()
        {
	...
	<log4net>
		...
		<logger name=""FileLogger"">
            ...
            string? filePath = Path.Combine(appsettings.Dir, "Log4net.config");
