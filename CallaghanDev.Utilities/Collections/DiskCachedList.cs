...
namespace CallaghanDev.Utilities.Collections
{
    ...
    public sealed class DiskCachedList<T> : IEnumerable<T>, IDisposable
    {
        ...
        public DiskCachedList(string? storagePath = null, int threshold = 100_000, Func<T, byte[]>? serializer = null, Func<byte[], T>? deserializer = null)
        {
        ...
        public ulong Count => _totalCount;
