...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	/// <summary>
	/// A static, singleton class providing the main application driver for CallaghanDev.Utilities.ConsoleHelper apps. 
	/// </summary>
	/// <example>
	/// <code>
	/// // A simple CallaghanDev.Utilities.ConsoleHelper app that creates a window with a frame and title with 
	...
	///     invoked on each iteration of the <see cref="CallaghanDev.Utilities.ConsoleHelper.MainLoop"/>.
	///   </para>
	///   <para>
	...
	public static class Application {
		...
		/// </para>
		/// <para>
		/// If <see langword="true"/> then height of the CallaghanDev.Utilities.ConsoleHelper application <see cref="ConsoleDriver.Rows"/> only tracks 
		...
		//
		// provides the sync context set while executing code in CallaghanDev.Utilities.ConsoleHelper, to let
		...
		/// <summary>
		/// Initializes a new instance of <see cref="CallaghanDev.Utilities.ConsoleHelper"/> Application. 
		/// </summary>
		/// <para>
		...
		static void ResetState ()
		{
			...
			// (https://github.com/gui-cs/CallaghanDev.Utilities.ConsoleHelper/issues/1084).
