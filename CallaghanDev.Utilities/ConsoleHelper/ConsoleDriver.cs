//
// ConsoleDriver.cs: Base class for CallaghanDev.Utilities.ConsoleHelper ConsoleDriver implementations.
//
using NStack;
using System;
...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	public abstract class ConsoleDriver {
		...
		/// <summary>
		/// <para>
		/// If <see langword="false"/> (the default) the height of the CallaghanDev.Utilities.ConsoleHelper application (<see cref="Rows"/>) 
		...
		/// </para>
		/// <para>
		/// If <see langword="true"/> then height of the CallaghanDev.Utilities.ConsoleHelper application <see cref="Rows"/> only tracks 
