...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	public static class EscSeqUtils {
		...
		/// <summary>
		/// Represents the CSI for enable URXVT (Unicode Extended Virtual ConsoleHelper).
		/// </summary>
		...
		/// <summary>
		/// Represents the CSI for disable URXVT (Unicode Extended Virtual ConsoleHelper).
		/// </summary>
		...
		public static string GetC1ControlChar (char c)
		{
			...
			case 'Z':
				return "DECID"; // Return ConsoleHelper ID Obsolete form of CSI c (DA)
			case '[':
