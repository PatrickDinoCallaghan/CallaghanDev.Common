...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	public class Pos {
		...
		/// <summary>
		/// Adds a <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> to a <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/>, yielding a new <see cref="Pos"/>.
		/// </summary>
		/// <param name="left">The first <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> to add.</param>
		/// <param name="right">The second <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> to add.</param>
		...
		/// <summary>
		/// Subtracts a <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> from a <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/>, yielding a new <see cref="Pos"/>.
		/// </summary>
		/// <param name="left">The <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> to subtract from (the minuend).</param>
		/// <param name="right">The <see cref="CallaghanDev.Utilities.ConsoleHelper.Pos"/> to subtract (the subtrahend).</param>
	...
	public class Dim {
		...
		/// <summary>
		/// Adds a <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> to a <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/>, yielding a new <see cref="Dim"/>.
		/// </summary>
		/// <param name="left">The first <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> to add.</param>
		/// <param name="right">The second <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> to add.</param>
		...
		/// <summary>
		/// Subtracts a <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> from a <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/>, yielding a new <see cref="Dim"/>.
		/// </summary>
		/// <param name="left">The <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> to subtract from (the minuend).</param>
		/// <param name="right">The <see cref="CallaghanDev.Utilities.ConsoleHelper.Dim"/> to subtract (the subtrahend).</param>
