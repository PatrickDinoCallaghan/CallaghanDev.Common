...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	///   </para>
	///   <para>
	///     A Toplevel is created when an application initializes CallaghanDev.Utilities.ConsoleHelper by calling <see cref="Application.Init(ConsoleDriver, IMainLoopDriver)"/>.
