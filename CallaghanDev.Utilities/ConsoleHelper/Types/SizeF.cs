...
namespace CallaghanDev.Utilities.ConsoleHelper {
	...
	public struct SizeF : IEquatable<SizeF> {
		/// <summary>
		/// Initializes a new instance of the <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> class from the specified
		/// existing <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> class from the specified
		/// <see cref='CallaghanDev.Utilities.ConsoleHelper.PointF'/>.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> class from the specified dimensions.
		/// </summary>
		...
		/// <summary>
		/// Performs vector addition of two <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> objects.
		/// </summary>
		public static SizeF operator + (SizeF sz1, SizeF sz2) => Add (sz1, sz2);

		/// <summary>
		/// Contracts a <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> by another <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>
		/// </summary>
		...
		/// <summary>
		/// Tests whether two <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> objects are identical.
		/// </summary>
		public static bool operator == (SizeF sz1, SizeF sz2) => sz1.Width == sz2.Width && sz1.Height == sz2.Height;

		/// <summary>
		/// Tests whether two <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> objects are different.
		/// </summary>
		public static bool operator != (SizeF sz1, SizeF sz2) => !(sz1 == sz2);

		/// <summary>
		/// Converts the specified <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> to a <see cref='CallaghanDev.Utilities.ConsoleHelper.PointF'/>.
		/// </summary>
		public static explicit operator PointF (SizeF size) => new PointF (size.Width, size.Height);

		/// <summary>
		/// Tests whether this <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/> has zero width and height.
		/// </summary>
		[Browsable (false)]
		public bool IsEmpty => width == 0 && height == 0;

		/// <summary>
		/// Represents the horizontal component of this <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>.
		/// </summary>
		public float Width {
			get => width;
			set => width = value;
		...
		/// <summary>
		/// Represents the vertical component of this <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>.
		/// </summary>
		public float Height {
			get => height;
			set => height = value;
		...
		/// <summary>
		/// Tests to see whether the specified object is a <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>  with the same dimensions
		/// as this <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>.
		/// </summary>
		...
		/// <summary>
		/// Creates a human-readable string that represents this <see cref='CallaghanDev.Utilities.ConsoleHelper.SizeF'/>.
		/// </summary>
