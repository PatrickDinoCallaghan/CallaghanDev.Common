...
namespace CallaghanDev.Utilities.ConsoleHelper{
	...
	public partial class View : Responder, ISupportInitializeNotification {
		...
		/// <see cref="CallaghanDev.Utilities.ConsoleHelper.LayoutStyle.Absolute"/>, 
		/// LayoutSubviews does not change the <see cref="Frame"/>. If the style is <see cref="CallaghanDev.Utilities.ConsoleHelper.LayoutStyle.Computed"/>
		...
		/// <summary>
		/// Gets or sets the height of the view. Only used the <see cref="LayoutStyle"/> is <see cref="CallaghanDev.Utilities.ConsoleHelper.LayoutStyle.Computed"/>.
		/// </summary>
		...
		/// <summary>
		/// Forces validation with <see cref="CallaghanDev.Utilities.ConsoleHelper.LayoutStyle.Computed"/> layout
		...
		/// <summary>
		/// Gets or sets the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter"/> which can be handled differently by any derived class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of a <see cref="CallaghanDev.Utilities.ConsoleHelper.LayoutStyle.Absolute"/> <see cref="View"/> class with the absolute
		...
		/// <summary>
		/// Can be overridden if the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.Text"/> has
		...
		/// <summary>
		/// Gets or sets a flag that determines whether <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.Text"/> will have trailing spaces preserved
		/// or not when <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.WordWrap"/> is enabled. If <see langword="true"/> 
		/// any trailing spaces will be trimmed when either the <see cref="Text"/> property is changed or 
		/// when <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.WordWrap"/> is set to <see langword="true"/>.
		...
		/// <summary>
		/// Get or sets whether the view will use <see cref="CallaghanDev.Utilities.ConsoleHelper.Border"/> (if <see cref="Border"/> is set) to draw 
		...
		/// <summary>
		/// Get the width or height of the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.HotKeySpecifier"/> length.
		/// </summary>
		/// <param name="isWidth"><see langword="true"/> if is the width (default) <see langword="false"/> if is the height.</param>
		/// <returns>The length of the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.HotKeySpecifier"/>.</returns>
		...
		/// <summary>
		/// Gets the bounds size from a <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.Size"/>.
		/// </summary>
		/// <returns>The bounds size minus the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.HotKeySpecifier"/> length.</returns>
		...
		/// </summary>
		/// <returns>The text formatter size more the <see cref="CallaghanDev.Utilities.ConsoleHelper.TextFormatter.HotKeySpecifier"/> length.</returns>
		...
		/// </summary>
		/// <returns><see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.Normal"/> if <see cref="Enabled"/> is <see langword="true"/>
		/// or <see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.Disabled"/> if <see cref="Enabled"/> is <see langword="false"/>.
		...
		/// Determines the current <see cref="ColorScheme"/> based on the <see cref="Enabled"/> value.
		/// </summary>
		/// <returns><see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.Focus"/> if <see cref="Enabled"/> is <see langword="true"/>
		/// or <see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.Disabled"/> if <see cref="Enabled"/> is <see langword="false"/>.
		/// If it's overridden can return other values.</returns>
		...
		/// Determines the current <see cref="ColorScheme"/> based on the <see cref="Enabled"/> value.
		/// </summary>
		/// <returns><see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.HotNormal"/> if <see cref="Enabled"/> is <see langword="true"/>
		/// or <see cref="CallaghanDev.Utilities.ConsoleHelper.ColorScheme.Disabled"/> if <see cref="Enabled"/> is <see langword="false"/>.
		/// If it's overridden can return other values.</returns>
