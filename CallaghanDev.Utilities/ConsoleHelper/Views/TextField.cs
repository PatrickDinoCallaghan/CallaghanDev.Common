...
using NStack;
using CallaghanDev.Utilities.ConsoleHelper.Resources;
...
namespace CallaghanDev.Utilities.ConsoleHelper {
	...
	public class TextField : View {
		...
		public override bool ProcessKey (KeyEvent kb)
		{
			...
			// Needed for the Elmish Wrapper issue https://github.com/DieselMeister/CallaghanDev.Utilities.ConsoleHelper.Elmish/issues/2
			oldCursorPos = point;
