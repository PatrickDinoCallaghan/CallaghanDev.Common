...
using System.Linq;
using CallaghanDev.XML.Excel.Cells;
using CallaghanDev.XML.Extensions;
using CallaghanDev.XML.Utils;
using DocumentFormat.OpenXml;
using DocumentFormat.OpenXml.Packaging;
using DocumentFormat.OpenXml.Spreadsheet;
using static CallaghanDev.XML.Excel.XLWorkbook;

namespace CallaghanDev.XML.Excel.IO
{
    internal class PivotTablePartWriter
    {
            ...
            SaveContext context)
        {
            ...
            // TODO: improve performance as per https://github.com/CallaghanDev.XML/CallaghanDev.XML/pull/984#discussion_r217266491
