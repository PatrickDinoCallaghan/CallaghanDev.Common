...
namespace CallaghanDev.XML.Excel
{
    internal class XLSparklineStyle : IXLSparklineStyle, IEquatable<XLSparklineStyle>
    {
        ...
        /// <summary>Returns a value that indicates whether two <see cref="T:CallaghanDev.XML.Excel.XLSparklineStyle" /> objects have different values.</summary>
        ...
        /// <summary>Returns a value that indicates whether the values of two <see cref="T:CallaghanDev.XML.Excel.XLSparklineStyle" /> objects are equal.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
