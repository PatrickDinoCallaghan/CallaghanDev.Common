...
using CallaghanDev.XML.Excel.IO;
using Ap = DocumentFormat.OpenXml.ExtendedProperties;
using Formula = DocumentFormat.OpenXml.Spreadsheet.Formula;
using Op = DocumentFormat.OpenXml.CustomProperties;
using X14 = DocumentFormat.OpenXml.Office2010.Excel;
using Xdr = DocumentFormat.OpenXml.Drawing.Spreadsheet;
using static CallaghanDev.XML.Excel.XLPredefinedFormat.DateTime;
...
namespace CallaghanDev.XML.Excel
{
    ...
    public partial class XLWorkbook
    {
        ...
        internal static double CalculateColumnWidth(double charWidth, IXLFont font, XLWorkbook workbook)
        {
            ...
            // it causes inconsistency with conversion to other units, but other places in CallaghanDev.XML do = keep for now.
                              ...
                              XLWorksheet ws, Dictionary<Int32, IXLStyle> styleList, OpenXmlPartReader reader, Int32 rowIndex)
        {
            ...
            {
                // Internally CallaghanDev.XML stores cells as standard 1900-based style
